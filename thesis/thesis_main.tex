...
\usepackage{titling}
\title{Implementing Floating-Point Support in a Nanopass-Python Compiler}
\author{Marius Spill}
...
\begin{document}
    ...
    \input{chapters/3-design_architecture}
    ...
    \cleardoublepage
    \phantomsection
    \addcontentsline{toc}{chapter}{Bibliography} % 3. Tell the ToC to link here
