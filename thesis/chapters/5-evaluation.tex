...
This also surfaced a related, known limitation: occasionally the output contains a small rounding error, e.g. 3.100000001 instead of 3.100000, which traces back to Python's internal float representation rather than to the compiler itself.
